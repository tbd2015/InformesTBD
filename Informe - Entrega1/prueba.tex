...
\figura{Diagrama de Clases (sección 1)}{
	\includegraphics[width=15cm]{DiagramaDeClases2.jpg}
}

\figura{Diagrama de Clases (sección 2)}{
	\includegraphics[width=15cm]{DiagramaDeClases3.jpg}
}
...
\tabla{Observación OBS0}{
	\begin{tabular}[c]{|l|l|}
		\hline
		Número observación & \\ \hline
		Detalle observación & \\ \hline
		Acción a realizar & \\ \hline
		Justificación & \\ \hline
		Página del Informe & \\ \hline
	\end{tabular}
}
