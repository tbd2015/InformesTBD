...
\begin{figure}[hbtp]
\centering
\includegraphics[width=17cm]{DiagramaDeClases2.jpg}
\caption{Diagrama de Clases sección 1.}
\end{figure}

\begin{figure}[hbtp]
\centering
\includegraphics[width=17cm]{DiagramaDeClases3.jpg}
\caption{Diagrama de Clases sección 2.}
\end{figure}
...
\seccion{MODELO DE BASE DE DATOS.}

\seccion{ENTIDADES Y ATRIBUTOS.}
